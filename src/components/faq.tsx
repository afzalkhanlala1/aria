...
const QA = [
  ...
  },
  {
    ...
    a: "Aria focuses on cash-pay aesthetic services — front-desk operations, not protected health information storage. We sign BAAs with all subprocessors (Twilio, OpenAI/Anthropic enterprise) and follow HIPAA-grade transmission/storage practices. We provide your compliance documentation as part of onboarding.",
  },
  {
    q: "What if Aria mishandles a sensitive call?",
  ...
  },
  {
    ...
    a: "Yes. We script and tune Aria specifically for your clinic — name, tone, signature greetings, your team's vocabulary. You'll approve a 5-minute sample call before go-live.",
  },
  {
    q: "How does the 'database reactivation' work?",
    a: "On day one we ingest your dormant leads (typically 500–3,000). Aria runs a respectful, opt-out-compliant SMS sequence (and optional voice outreach for high-value segments) tied to a current promotion. Most clinics see 15–40 appointments booked in the first month. This alone usually pays for the whole year of service.",
  },
  {
